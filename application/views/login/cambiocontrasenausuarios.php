...
<div class="row panel control" style="margin-top: 15%;" >
    ...
    <div class="large-2 columns">
        <center><label for="correo">Contraseña</label></center>
    </div>
    <div class="large-10 columns"> 
        <input type="text" placeholder="Contraseña" id="contrasena">
    </div>
    <div class="large-2 columns">
        <center><label for="correo">Repetir Contraseña</label></center>
    </div>
    <div class="large-10 columns"> 
        <input type="text" placeholder="Contraseña" id="contrasena">
    </div>
