...
<h2 align="center">Administrador del menu</h2>
<br>
<table align="center">
    <thead>
        <th>Nombre Menu</th>
    ...
    $('.menu').click(function(){
        ...
        $('#alerta').dialog({
            ...
            buttons : [{
                    ...
                    text : "Actualizar",
                    click : function(){
                        var url =  "<?php echo  base_url('index.php/presentacion/guardarmenu') ?>";
                        var nombreactualizado = $('#nombremenu').val();
                        var estado = $('#estado').val();
                        $.post(url,{estado : estado,id : id , nombreactualizado : nombreactualizado},function(data){
