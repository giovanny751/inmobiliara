...
//            data.rep_id();
    ...
    $('body').delegate('.eliminar', 'click', function () {
        ...
        var confirmar = confirm('Esta seguro que desea eliminar el Reporte');
        var url = "<?= base_url('index.php/reportes/eliminarmodulo') ?>";
        if (confirmar == true) {
    ...
    $('#guardar').click(function () {
        ...
        var url = "<?= base_url('index.php/reportes/guardarmodulo') ?>";
    ...
    $('body').delegate('.guardar', 'click', function () {
        ...
        var url = "<?= base_url('index.php/reportes/guardaratributosmenu') ?>";
